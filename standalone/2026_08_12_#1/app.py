...
class AlarmClockPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.nl_edit.setFixedWidth(190)
    ...
    def _format_alarm_label(self, alarm, occurrence):
        if alarm["type"] == "once":
            return "일회성: " + occurrence.toString("yyyy-MM-dd HH:mm")
        days = "".join(WEEKDAY_NAMES[d] for d in sorted(alarm["weekdays"]))
        return f"주기적({days}) {alarm['time'].toString('HH:mm')} [~{alarm['end_date'].toString('yyyy-MM-dd')}]"
    ...
    def _refresh_list(self):
        ...
        for alarm in self._alarms:
            ...
            remaining = self._format_remaining(now.secsTo(occurrence))
            label_text = self._format_alarm_label(alarm, occurrence)

            row = QWidget()
            row_layout = QHBoxLayout(row)
            row_layout.setContentsMargins(4, 2, 4, 2)
            label = QLabel(f"{label_text}    남은 시간: {remaining}")
...
class GeneratedApp(QMainWindow):
    def __init__(self):
        ...
        self.tab1_button_1.move(191, 480)
        self.tab1_button_1.adjustSize()
        self.tab1_button_1.resize(292, 32)
        ...
        self.tab3_alarmclock_1.move(31, 17)
        self.tab3_alarmclock_1.adjustSize()
        self.tab3_alarmclock_1.resize(1033, 665)
        ...
        self.tab4_button_1.move(81, 180)
        self.tab4_button_1.adjustSize()
        self.tab4_button_1.resize(175, 39)
        ...
        self.tab4_lineedit_1.move(132, 63)
        self.tab4_lineedit_1.adjustSize()
        self.tab4_lineedit_1.resize(69, 39)
        ...
        self.tab4_button_2.move(81, 275)
        self.tab4_button_2.adjustSize()
        self.tab4_button_2.resize(145, 39)
        ...
        self.tab4_button_3.move(81, 367)
        self.tab4_button_3.adjustSize()
        self.tab4_button_3.resize(116, 36)
        ...
        self.tab4_hline_1.move(35, 126)
        self.tab4_hline_1.adjustSize()
        self.tab4_hline_1.resize(608, 36)
        ...
        self.tab4_vline_1.move(307, 44)
        self.tab4_vline_1.adjustSize()
        self.tab4_vline_1.resize(36, 631)
        ...
        self.tab4_lineedit_2.move(464, 58)
        self.tab4_lineedit_2.adjustSize()
        self.tab4_lineedit_2.resize(63, 40)
        ...
        self.tab4_button_4.move(384, 177)
        self.tab4_button_4.adjustSize()
        self.tab4_button_4.resize(234, 41)
